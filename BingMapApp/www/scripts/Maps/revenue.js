...
/*window.onload = function () {
   ...
   /* highestrevenue = document.getElementById('highestrevenue1');
    lowestrevenue = document.getElementById('lowestrevenue1');
    averagerevenue = document.getElementById('averagerevenue1');

    highesttargetedrevenue = document.getElementById('highestrevenuetargeted1');
    lowesttargetedrevenue = document.getElementById('lowestrevenuetargeted1');
    averagetargetedrevenue = document.getElementById('averagerevenuetargeted1');
...
//        $.ajax({
//            url: "http://localhost:1515/api/getrevenue/2016-2-1/revenuechart/37823b60-3a2e-48d6-8115-956771acb3e3/"+  deliverymanagersParameters 
//        }).then(function (data) {
//            DataBind(data);
//        });
...
//        $.ajax({
//            url: "http://localhost:1515/api/getrevenue/2016-4-1/revenuechart/37823b60-3a2e-48d6-8115-956771acb3e3/ " + deliverymanagersParameters
//        }).then(function (data) {
//            next(data);
//        });
...
//        $.ajax({
//            url: "http://localhost:1515/api/getrevenue/2015-10-1/revenuechart/37823b60-3a2e-48d6-8115-956771acb3e3/ " + deliverymanagersParameters
//        }).then(function (data) {
//            previous(data);
//        });
...
//        var data3 = [];
//        $.ajax({
//            url: "http://localhost:1515/api/getrevenue/2015-7-1/revenuechart/37823b60-3a2e-48d6-8115-956771acb3e3/ " + deliverymanagersParameters
//        }).then(function (data) {            
